---
tags: [moc, workflow]
aliases: ["Workflows Hub", "Workflows Map of Content"]
---
# Workflows MOC

Hub for the repeatable processes that run across the agency — how work moves from intake to build to handoff, plus the automation and knowledge pipelines that support it.
...
- [[n8n Content Approval Pipeline]] — human-in-the-loop drafting → admin approval → publish.
- [[Knowledge Graph Workflow]] — graphify files/projects into a navigable knowledge graph and grow this vault.
